...
draft: false
---
<section class="page-section visible">
<div class="section-header">
<h2>Projects</h2>
<p class="section-subtitle">A collection of my personal projects. Lots more to come!</p>
</div>
...
<h3>NU Tech Ethics Initiative</h3>
<p>I collaborated with faculty of Northwestern's Computer Science department to integrate ethics modules into 4 courses. I helped secure $12,500 in funding for the program, and was also a guest speaker for the Northwestern AI course in collaboration with Kaplan.</p>
<div class="project-tags"><span class="ptag">AI Ethics</span><span class="ptag">Curriculum Design</span><span class="ptag">Education</span></div>
<a href="https://sites.northwestern.edu/embeddingethics/" target="_blank" class="project-link">Visit site →</a>
</div>
<div class="project-card">
<div class="project-icon"><i class="fa-solid fa-chart-bar"></i></div>
